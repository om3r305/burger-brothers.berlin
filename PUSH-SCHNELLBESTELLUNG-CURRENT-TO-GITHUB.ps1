...
$ExpectedBranch = 'main'
$CommitMessage = 'feat: add secure Schnellbestellung QR ordering channel'

$Stamp = Get-Date -Format 'yyyyMMdd-HHmmss'
$BackupRoot = 'C:\Web\burger-github-backups'
$Backup = Join-Path $BackupRoot ("schnellbestellung-current-rev3-" + $Stamp)

$CommitCreated = $false
$OriginalHead = $null

# Ilk Schnellbestellung tesliminden V1.3 TV sound/typecheck duzeltmesine kadar
# GitHub'a gitmesi gereken tum guncel kaynaklar.
$Changed = @(
    ...
    'SCHNELLBESTELLUNG-V1.2-ADMIN-AUTH-FIX-REPORT.md',
    'SCHNELLBESTELLUNG-V1.3-TV-SOUND-FIX-REPORT.md',
    'CHANGED-FILES-SCHNELLBESTELLUNG-V1.3.txt',
    'SHA256SUMS-SCHNELLBESTELLUNG-V1.3.txt',

    'PUSH-SCHNELLBESTELLUNG-CURRENT-TO-GITHUB.ps1'
)
...
Write-Host ' SCHNELLBESTELLUNG REV3 - V1-V1.3 / TEST / COMMIT / PUSH' -ForegroundColor Cyan
Write-Host '=================================================================' -ForegroundColor Cyan
Write-Host ''
...
try {
    Write-Step '[2/10] Tum Schnellbestellung dosyalari yedekleniyor ve kopyalaniyor...'
    ...
    Write-Step '[9/10] Yalniz Schnellbestellung teslimat dosyalari stage ediliyor...'
    ...
    Write-Host ' SCHNELLBESTELLUNG GITHUB GONDERIMI BASARILI' -ForegroundColor Green
    Write-Host '=================================================================' -ForegroundColor Green
    Write-Host "Branch : $branch" -ForegroundColor Cyan
