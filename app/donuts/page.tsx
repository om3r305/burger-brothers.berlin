        ...
        <div className="grid-cards">
          {!loaded ? (
            ...
            <div className="text-sm text-stone-400">
              Noch keine <strong>Donuts</strong> vorhanden. Bitte im Admin-Bereich Produkte mit der Kategorie{" "}
              <b>„Donuts“</b> anlegen.
            </div>
          ) : (
            donuts.map((donut) => {
              const applied = priceWithCampaign(
                {
                  ...
                  name: donut.name,
                  price: donut.price,
                  category: "donuts" as CatalogCategory,
                },
                campaigns,
                orderMode,
                now
              ...
              return (
                <div key={donut.id} className="menu-card">
                  <SauceCard
                    sku={donut.id}
                    name={donut.name}
                    price={applied?.final ?? donut.price}
