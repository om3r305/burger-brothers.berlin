...
$CommitMessage = 'fix: allow admin to save Schnellbestellung settings'
$Stamp = Get-Date -Format 'yyyyMMdd-HHmmss'
$BackupRoot = 'C:\Web\burger-github-backups'
$Backup = Join-Path $BackupRoot ("schnellbestellung-v1.2-$Stamp")
$CommitCreated = $false
...
$Changed = @(
    ...
    'CHANGED-FILES-SCHNELLBESTELLUNG-V1.2.txt',
    'SCHNELLBESTELLUNG-V1.2-ADMIN-AUTH-FIX-REPORT.md',
    'SHA256SUMS-SCHNELLBESTELLUNG-V1.2.txt',
    'PUSH-SCHNELLBESTELLUNG-V1.2-TO-GITHUB.ps1'
)
...
Write-Host ' SCHNELLBESTELLUNG V1.2 - TEST / COMMIT / PUSH' -ForegroundColor Cyan
Write-Host '========================================================' -ForegroundColor Cyan
Write-Host ''
