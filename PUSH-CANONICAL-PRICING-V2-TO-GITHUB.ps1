...
Canonical pricing kök düzeltmesi V2 GitHub gönderimi
...
try {
    ...
    try {
        ...
        Invoke-Native "git" @(
            "commit",
            "-m",
            "fix(pricing): canonicalize checkout totals without blocking v2"
        ...
        Write-Host "CANONICAL PRICING V2 DÜZELTMESİ GITHUB'A GÖNDERİLDİ" -ForegroundColor Green
        Write-Host "============================================================" -ForegroundColor Green
