...
$ExpectedBranch = 'main'
$CommitMessage = 'feat: finalize fast Schnellbestellung service flow'

$Stamp = Get-Date -Format 'yyyyMMdd-HHmmss'
$BackupRoot = 'C:\Web\burger-github-backups'
$Backup = Join-Path $BackupRoot ("schnellbestellung-final-v3-" + $Stamp)
...
types/tv.ts
README-SCHNELLBESTELLUNG-FINAL-V3.md
VERIFY-SCHNELLBESTELLUNG-FINAL-V3.md
CHANGED-FILES-SCHNELLBESTELLUNG-FINAL-V3.txt
SHA256SUMS-SCHNELLBESTELLUNG-FINAL-V3.txt
PUSH-SCHNELLBESTELLUNG-FINAL-V3-TO-GITHUB.ps1
...
Write-Host ' SCHNELLBESTELLUNG FINAL V3 / TEST / BUILD / COMMIT / GITHUB PUSH' -ForegroundColor Cyan
Write-Host '====================================================================' -ForegroundColor Cyan
Write-Host ''
...
try {
    ...
    Write-Step '[9/10] Yalnız Final V3 dosyaları stage ediliyor...'
    ...
    if ($Staged.Count -eq 0) {
        Write-Host 'Bütün Final V3 dosyaları zaten GitHub ile aynı.' -ForegroundColor Green
    ...
    Write-Host ' SCHNELLBESTELLUNG FINAL V3 GITHUB GÖNDERİMİ BAŞARILI' -ForegroundColor Green
    Write-Host '====================================================================' -ForegroundColor Green
    Write-Host "Branch: $Branch" -ForegroundColor Cyan
