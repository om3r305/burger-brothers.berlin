...
assert(client.includes("playOrderConfirmationSoundOnce"));
...
assert(success.includes("Sie können BB Schnell jetzt schließen."));
...
assert(success.includes("startSchnellReadyAlarm"));
assert(success.includes("stopSchnellReadyAlarm"));
assert(success.includes("readyOpenedFromNotification"));
assert(success.includes("BB_SCHNELL_NOTIFICATION_OPEN"));
