...
$ExpectedBranch = 'main'
$CommitMessage = 'fix: request iOS Home Screen push permission explicitly'

$Stamp = Get-Date -Format 'yyyyMMdd-HHmmss'
$BackupRoot = 'C:\Web\burger-github-backups'
$Backup = Join-Path $BackupRoot ("schnell-ios-push-prompt-v71-" + $Stamp)
...
README-SCHNELL-IOS-PUSH-PROMPT-V7.1.md
VERIFY-SCHNELL-IOS-PUSH-PROMPT-V7.1.md
CHANGED-FILES-SCHNELL-IOS-PUSH-PROMPT-V7.1.txt
SHA256SUMS-SCHNELL-IOS-PUSH-PROMPT-V7.1.txt
PUSH-SCHNELL-IOS-PUSH-PROMPT-V7.1-TO-GITHUB.ps1
RUN-SCHNELL-IOS-PUSH-PROMPT-V7.1-GITHUB-PUSH.bat
'@
...
Write-Host ' SCHNELL IOS PUSH PROMPT V7.1 / TEST / BUILD / COMMIT / GITHUB PUSH' -ForegroundColor Cyan
Write-Host '====================================================================' -ForegroundColor Cyan
Write-Host ''
...
try {
    ...
    Write-Step '[9/10] Yalnız iOS Push Prompt V7.1 dosyaları stage ediliyor...'
    ...
    if ($Staged.Count -eq 0) {
        Write-Host 'Bütün iOS Push Prompt V7.1 dosyaları zaten GitHub ile aynı.' -ForegroundColor Green
    ...
    Write-Host ' SCHNELL IOS PUSH PROMPT V7.1 GITHUB GÖNDERİMİ BAŞARILI' -ForegroundColor Green
    Write-Host '====================================================================' -ForegroundColor Green
    Write-Host "Branch: $Branch" -ForegroundColor Cyan
