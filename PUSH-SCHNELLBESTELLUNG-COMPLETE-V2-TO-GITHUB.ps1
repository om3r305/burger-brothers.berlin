...
$ExpectedBranch = 'main'
$CommitMessage = 'feat: complete Schnellbestellung in-store ordering controls'

$Stamp = Get-Date -Format 'yyyyMMdd-HHmmss'
$BackupRoot = 'C:\Web\burger-github-backups'
$Backup = Join-Path $BackupRoot ("schnellbestellung-complete-v2-" + $Stamp)

$CommitCreated = $false
$OriginalHead = $null

# Schnellbestellung Complete V2 teslimatinda degisen ve eklenen dosyalar.
$Changed = @(
    ...
    'README-SCHNELLBESTELLUNG-COMPLETE-V2.md',
    'VERIFY-SCHNELLBESTELLUNG-COMPLETE-V2.md',
    'CHANGED-FILES-SCHNELLBESTELLUNG-COMPLETE-V2.txt',
    'SHA256SUMS-SCHNELLBESTELLUNG-COMPLETE-V2.txt',
    'PUSH-SCHNELLBESTELLUNG-COMPLETE-V2-TO-GITHUB.ps1',
    'RUN-SCHNELLBESTELLUNG-COMPLETE-V2-GITHUB-PUSH.bat'
)
...
Write-Host ' SCHNELLBESTELLUNG COMPLETE V2 / TEST / COMMIT / PUSH' -ForegroundColor Cyan
Write-Host '=================================================================' -ForegroundColor Cyan
Write-Host ''
...
try {
    ...
    Write-Host ' SCHNELLBESTELLUNG COMPLETE V2 GITHUB GONDERIMI BASARILI' -ForegroundColor Green
    Write-Host '=================================================================' -ForegroundColor Green
    Write-Host "Branch : $branch" -ForegroundColor Cyan
