...
Checkout güvenli tip / toast / accessibility refactor GitHub gönderimi
...
try {
    ...
    try {
        ...
        Invoke-Native "git" @(
            "commit",
            "-m",
            "refactor(checkout): harden types feedback and accessibility"
        ...
        Write-Host "CHECKOUT GÜVENLİ REFACTOR GITHUB'A GÖNDERİLDİ" -ForegroundColor Green
        Write-Host "============================================================" -ForegroundColor Green
