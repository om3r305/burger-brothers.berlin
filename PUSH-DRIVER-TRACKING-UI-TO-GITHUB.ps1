...
Driver tracking race + UI contrast GitHub gönderimi

Dosya doğrudan C:\Web\burger içine konulup oradan çalıştırılır.
...
$files = @(
    ...
    "docs\driver-tracking-ui-20260722\README.md"
    "docs\driver-tracking-ui-20260722\CHANGED-FILES.txt"
    "docs\driver-tracking-ui-20260722\VERIFY.txt"
)
...
$backupRoot = Join-Path $env:TEMP (
    "burger-driver-tracking-ui-backup-" + (Get-Date -Format "yyyyMMdd-HHmmss")
)
...
try {
    ...
    try {
        ...
        Write-Step "Driver tracking/UI regresyon testi"
        ...
        Invoke-Native "git" @(
            "commit",
            "-m",
            "fix(driver): stabilize tracking and improve controls"
        ...
        Write-Host "DRIVER TRACKING + UI DÜZELTMESİ GITHUB'A GÖNDERİLDİ" -ForegroundColor Green
        Write-Host "============================================================" -ForegroundColor Green
