...
$ExpectedBranch = 'main'
$CommitMessage = 'fix: use exact variant names and repeat ready alerts'

$Stamp = Get-Date -Format 'yyyyMMdd-HHmmss'
$BackupRoot = 'C:\Web\burger-github-backups'
$Backup = Join-Path $BackupRoot ("schnell-variant-ready-v5-" + $Stamp)
...
README-SCHNELL-VARIANT-READY-V5.md
VERIFY-SCHNELL-VARIANT-READY-V5.md
CHANGED-FILES-SCHNELL-VARIANT-READY-V5.txt
SHA256SUMS-SCHNELL-VARIANT-READY-V5.txt
PUSH-SCHNELL-VARIANT-READY-V5-TO-GITHUB.ps1
...
Write-Host ' SCHNELL VARIANT + READY ALERT V5 / TEST / BUILD / COMMIT / GITHUB PUSH' -ForegroundColor Cyan
Write-Host '====================================================================' -ForegroundColor Cyan
Write-Host ''
...
try {
    ...
    Write-Host ' SCHNELL VARIANT + READY ALERT V5 GITHUB GÖNDERİMİ BAŞARILI' -ForegroundColor Green
    Write-Host '====================================================================' -ForegroundColor Green
    Write-Host "Branch: $Branch" -ForegroundColor Cyan
