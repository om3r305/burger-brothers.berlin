...
$ExpectedBranch = 'main'
$CommitMessage = 'fix: polish Schnellbestellung catalog alerts and TV ready flow'

$Stamp = Get-Date -Format 'yyyyMMdd-HHmmss'
$BackupRoot = 'C:\Web\burger-github-backups'
$Backup = Join-Path $BackupRoot ("schnellbestellung-polish-v4-" + $Stamp)
...
README-SCHNELLBESTELLUNG-POLISH-V4.md
VERIFY-SCHNELLBESTELLUNG-POLISH-V4.md
CHANGED-FILES-SCHNELLBESTELLUNG-POLISH-V4.txt
SHA256SUMS-SCHNELLBESTELLUNG-POLISH-V4.txt
PUSH-SCHNELLBESTELLUNG-POLISH-V4-TO-GITHUB.ps1
...
Write-Host ' SCHNELLBESTELLUNG POLISH V4 / TEST / BUILD / COMMIT / GITHUB PUSH' -ForegroundColor Cyan
Write-Host '====================================================================' -ForegroundColor Cyan
Write-Host ''
...
try {
    ...
    Write-Step '[6/10] TypeScript ve hedefli regression testleri çalışıyor...'
    ...
    Write-Step '[9/10] Yalnız Polish V4 dosyaları stage ediliyor...'
    ...
    if ($Staged.Count -eq 0) {
        Write-Host 'Bütün Polish V4 dosyaları zaten GitHub ile aynı.' -ForegroundColor Green
    ...
    Write-Host ' SCHNELLBESTELLUNG POLISH V4 GITHUB GÖNDERİMİ BAŞARILI' -ForegroundColor Green
    Write-Host '====================================================================' -ForegroundColor Green
    Write-Host "Branch: $Branch" -ForegroundColor Cyan
